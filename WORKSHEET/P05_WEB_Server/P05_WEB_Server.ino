...
// Wi-Fi credentials
const char* ssid     = "WIFI_NETWORK";       // Your Wi-Fi network name
    ...
    while (client.connected()) {
      if (client.available()) {
        ...
        if (c == '\n') {  // End of HTTP request line
          ...
          client.println("<body>");
          client.println("<h1>Welcome to Ashwin's ESP32 Server</h1>");
          client.println("<p>This web page is served from my ESP32 board.</p>");
          client.println("<p>Created by: <strong>Ashwin Kumar H</strong></p>");
